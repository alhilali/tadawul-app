...
@Component({
  ...
  styleUrls: ['./styles/firebase-profile.page.scss', './styles/firebase-profile.shell.scss'],
})
export class FirebaseProfilePage implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute, public authService: FirebaseAuthService) {}
